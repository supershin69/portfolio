      ...
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-10 items-center h-full pt-20">
        ...
        <div className="order-2 md:order-1 flex flex-col justify-center space-y-6 z-10">
          ...
          <div className="flex space-x-6 pt-4">
            <a href="#" className="hover:scale-110 transition-transform"><Linkedin size={30} /></a>
            <a href="#" className="hover:scale-110 transition-transform"><Github size={30} /></a>
            <a href="#" className="hover:scale-110 transition-transform"><Send size={30} /></a>
          </div>
        </div>
